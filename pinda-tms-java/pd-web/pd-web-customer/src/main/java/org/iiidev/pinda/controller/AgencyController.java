...
public class AgencyController {
    ...
    @GetMapping("page")
    public RespResult page(Integer page, Integer pagesize, Long cityId, String keyword, String latitude, String longitude) {

        Result<Page> result = orgApi.pageLike(pagesize, page, keyword, cityId, latitude, longitude);
        ...
        return RespResult.ok().put("data",PageResponse.<Map>builder()
                .items(records)
                .pagesize(pagesize)
                .page(page)
