...
import org.iiidev.pinda.vo.base.businessHall.CourierScopeVo;
...
public class BusinessHallController {
    ...
    public RespResult saveCourierScope(@RequestBody CourierScopeVo vo) {
        //验证和处理范围和区域信息
     ...
     * @return
     */
    private RespResult validateParam(CourierScopeVo vo) {
