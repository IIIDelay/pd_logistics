...
import org.iiidev.pinda.mapper.MessageMapper;
import org.iiidev.pinda.service.DruidService;
...
public class DruidServiceImpl implements DruidService {
     ...
     */
    @Override
    public RespResult queryAllTruckLast(Map<String, Object> params) {
        ...
        return RespResult.ok().put("data", messageEntities);
    }
     ...
     */
    @Override
    public RespResult queryOneTruck(Map<String, Object> params) {
        params.put("type", "truck");
        ...
        return RespResult.ok().put("data", baseMap);
    }
     ...
     */
    @Override
    public RespResult queryAll(List<Map<String, Object>> params) {
        ...
        return RespResult.ok().put("data", resultMap);
    }
