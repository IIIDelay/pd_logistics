...
public class DruidController {
    ...
    public RespResult select(@RequestParam Map<String, Object> params) {
        return druidService.queryAllTruckLast(params);
    }

    @ApiOperation("查询Druid当前车辆的全部位置")
    @RequestMapping(value = "/selectOne")
    public RespResult selectOne(@RequestParam Map<String, Object> params) {
        return druidService.queryOneTruck(params);
    }

    @ApiOperation("查询Druid当前参数全部位置")
    @RequestMapping(value = "/selectByList")
    public RespResult selectByList(@RequestBody List<Map<String, Object>> params) {
