package org.iiidev.pinda.feign.transportline;
...
public interface TransportTripsFeign {
    ...
    RespResult disable(@PathVariable(name = "id") String id);
    ...
    RespResult batchSaveTruckDriver(@PathVariable("id") String transportTripsId, @RequestBody List<TransportTripsTruckDriverDto> dtoList);
