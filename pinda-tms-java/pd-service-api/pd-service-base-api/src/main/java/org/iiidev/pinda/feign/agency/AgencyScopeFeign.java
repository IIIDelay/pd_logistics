package org.iiidev.pinda.feign.agency;
...
public interface AgencyScopeFeign {
    ...
    RespResult batchSaveAgencyScope(@RequestBody List<AgencyScopeDto> dtoList);
    ...
    RespResult deleteAgencyScope(@RequestBody AgencyScopeDto dto);
