package org.iiidev.pinda.feign.user;
...
public interface CourierScopeFeign {
    ...
    RespResult batchSaveCourierScope(@RequestBody List<CourierScopeDto> dtoList);
    ...
    RespResult deleteCourierScope(@RequestBody CourierScopeDto dto);
