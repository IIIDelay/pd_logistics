package org.iiidev.pinda.controller.transportline;
...
import org.iiidev.pinda.entity.transportline.PdTransportTrips;
import org.iiidev.pinda.entity.transportline.PdTransportTripsTruckDriver;
import org.iiidev.pinda.service.transportline.IPdTransportTripsService;
import org.iiidev.pinda.DTO.transportline.TransportTripsDto;

import org.iiidev.pinda.service.transportline.IPdTransportTripsTruckDriverService;
...
public class TransportTripsController {
    ...
    public RespResult disable(@PathVariable(name = "id") String id) {
    ...
    public RespResult batchSaveTruckDriver(@PathVariable("id") String transportTripsId, @RequestBody List<TransportTripsTruckDriverDto> dtoList) {
