...
import org.iiidev.pinda.authority.dto.core.StationUpdateDTO;
...
public class StationController extends BaseController {
    ...
    @GetMapping("/page")
    @SysLog("分页查询岗位")
    public Result<IPage<Station>> page(StationPageDTO data) {
    ...
    @GetMapping("/{id}")
    @SysLog("查询岗位")
    public Result<Station> get(@PathVariable Long id) {
