 ...
 * 一个服务如何配置多数据源？
 * <p>
 * 1. 本类中的 basePackages = {"org.iiidev.pinda"}, 修改为  basePackages = {"org.iiidev.pinda.product.dao"}  # 这个路径根据你的情况修改
 ...
 * 6. SlaveDatabaseAutoConfiguration 中的 basePackages = {"org.iiidev.pinda"}, 修改为  basePackages = {"org.iiidev.pinda.order.dao"} # 这个路径根据你的情况修改
 * 7. mysql.yml 中增加2个数据源的配置 spring.database.druid.master 和 spring.database.druid.slave
 * <p>
 * 完成上述修改后， 位于com.itheima.pinda.product.dao 包下的dao 将操作  master 库， org.iiidev.pinda.order.dao中的dao 将操作slave库
 */
@Configuration
@Slf4j
@MapperScan(
