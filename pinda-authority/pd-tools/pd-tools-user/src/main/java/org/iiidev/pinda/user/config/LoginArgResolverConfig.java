package org.iiidev.pinda.user.config;

import java.util.List;
import org.iiidev.pinda.user.feign.UserResolveApi;
import org.iiidev.pinda.user.interceptor.ContextHandlerInterceptor;
import org.iiidev.pinda.user.resolver.ContextArgumentResolver;
