package org.iiidev.pinda.xss.filter;

import com.alibaba.fastjson.JSON;
import lombok.extern.slf4j.Slf4j;
import org.apache.commons.collections4.CollectionUtils;
import org.apache.commons.lang3.StringUtils;
import org.iiidev.pinda.xss.wrapper.XssRequestWrapper;
...
public class XssFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        ...
        if (StringUtils.isNotBlank(ignoreParamValues)) {
    ...
    private boolean isIgnorePath(String servletPath) {
        ...
        if (CollectionUtils.isEmpty(ignorePathList)) {
            ...
            for (String ignorePath : ignorePathList) {
                if (StringUtils.isNotBlank(ignorePath) && servletPath.contains(ignorePath.trim())) {
                    return true;
                }
            }
        }
