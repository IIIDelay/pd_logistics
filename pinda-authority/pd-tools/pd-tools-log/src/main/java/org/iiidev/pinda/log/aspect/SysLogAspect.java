package org.iiidev.pinda.log.aspect;
...
import org.iiidev.pinda.log.event.SysLogEvent;
import org.iiidev.pinda.log.util.LogUtil;
...
public class SysLogAspect {
     ...
     */
    @Pointcut("@annotation(org.iiidev.pinda.log.annotation.SysLog)")
...
//
//        Result r = Convert.convert(Result.class, obj);
//        if (r.getIsSuccess()) {
